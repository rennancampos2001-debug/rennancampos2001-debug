...
![SolidWorks](https://img.shields.io/badge/SolidWorks-CAD-E2211B?style=for-the-badge\&logo=dassaultsystemes)
...
Minha principal área dentro da FRC é o **projeto do robô**.

Utilizo ferramentas de CAD para transformar conceitos e ideias em projetos que possam ser fabricados, montados e utilizados no robô.
...
* Iteração e melhoria de projetos

---

#  Programação

Embora minha principal área atualmente seja **projeto**, também estou estudando programação.

Tenho interesse em futuramente atuar mais diretamente com **software e programação de robôs**, unindo meus conhecimentos de engenharia mecânica e tecnologia.
...
*  HTML
*  Git & GitHub
*  Programação aplicada à robótica
 ...
 **FIRST Championship — Houston, USA**
...
*  Evoluir como projetista de robôs
*  Aprofundar meus conhecimentos em CAD
*  Aprender programação para robótica
*  Desenvolver projetos cada vez mais completos
*  Criar soluções de engenharia
*  Contribuir cada vez mais com a Stardust
*  Continuar aprendendo através da robótica
...
Estou construindo meu portfólio através de projetos de:

** Robótica**

Projetos relacionados ao desenvolvimento e projeto de robôs.

** CAD**

Modelagem 3D, mecanismos e projetos de engenharia.

** Programação**

Projetos desenvolvidos durante minha evolução em Python, Java e outras tecnologias.
...
Atualmente estou construindo meu portfólio e minha presença profissional na área de tecnologia.
